...
function AddStats() {
	...
	let p = stats.querySelectorAll("p.stats");
		p[0].innerHTML = "Tamamlanma zamanı: " + minutes + " Dakika ve" + seconds + " Saniye";
		p[1].innerHTML = "Toplam Hamle  " + moves;
		p[2].innerHTML = "Yıldız Derecelendirmeniz: " + starCount + "( 3 üzerinden)";
}
